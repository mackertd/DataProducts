...
This tab allows the user to explore a portion of the GRanD Dams data set using a slider control. As the user manipulates the slider control the output in the bar chart is updated as well as the displays showing the Minimum and Maximum Number of Dams and the Mean and Median of the dams displayed.

## Slider Control

The user selects and moves the dot on the slider control to adjust the the Minimum (Left Dot) number of dams and the Maximum (Right Dot) number of dams.  As the user moves the dots for the minimum and maximum number of dams the four data display boxes at the top and the bar chart update with the new values.
...
Hovering over a circle with show a polygon of the area in which the dams are located.
...
Click on a blue Placemark to show the dam name.

# Documentation Tab

Provides documentation for the user to utilize the application
